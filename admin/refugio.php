        ...
        <div class="row">
            <div class="container">
                        ...
                        <div class="apartado">
                            ...
                            <div class="row p-3" style="font-size: 18px">
                                ...
                                <div class="col-12 col-md-6">
                                    <h5 class="text-center pt-3 pt-md-4 pb-3">Información del dueño.</h5>
                    ...
                    <div class="p-0 p-md-2 col-12 pb-3">
                        <div class="apartado">
                            ...
                            <div class="row p-3" style="font-size: 18px">
                                ...
                                <div class="col-12 col-md-6">
                                    <h5 class="text-center pt-3 pt-md-4 pb-3">Información del refugio.</h5>
                                    <div class="pl-4 pl-md-0">
                                        <p class="p-0 p-md-1">Nombre: <b>Ori's Haven</b></p>
                                        <p class="p-0 p-md-1">Abierto desde: <b>@diainicial</b></p>
                                        <p class="p-0 p-md-1">Hasta: <b>@diafinal</b></p>
                                        <p class="p-0 p-md-1">En un horario de: <b>@horainicial</b></p>
                                        <p class="p-0 p-md-1">A: <b>@horafinal</b></p>
                                        <p class="p-0 p-md-1">Domicilio: <b>8 sur</b></p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="text-center pb-4">
                    <div class="btn btn-info text-center" style="font-size:20px;" onclick="location='editarRefugio.php'">
                        Editar
                    </div>
                </div>
