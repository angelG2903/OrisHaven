    ...
    <div class="container">
        ...
        <div class="row">
            <div class="container">
                ...
                <?php include 'php/mostrarA.php'; ?>
                <!-- <div class="row">
                    <div class="p-0 p-md-2 col-12 pb-3">
                        <div class="apartado">
                            <div class="d-xl-none text-center pt-3">
                                <img src="../img/persona.png" alt="" class="w-75 sombra mascotas">
                            </div>
                            <div class="row p-3 ">
                                <div class="d-none d-xl-block col-md-3 pt-2 pt-0">
                                    <img src="../img/persona.png" alt="" class="img-fluid sombra mascotas w-100">
                                </div>
                                ...
                                <div class="col-12 col-md-3 pt-0 pt-md-5 d-none d-xl-block">
                                    <div class="pt-0 pt-md-5">
                                        <button class="btn btn-info sombra" onclick="location='vistaPerfil.php'">Ver más</button>
                                    </div>
                                </div>
